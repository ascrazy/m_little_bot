...
describe("toNotionBlocks", () => {
  test("plain text paragraph", () => {
    expect(
      diff(toNotionBlocks(toParagraphs("Hello World!\n\nHey Jude!", [])), [
        {
          object: "block",
          paragraph: {
            rich_text: [
  ...
  test("paragraph with URL", () => {
    expect(
      diff(
        toNotionBlocks(
          toParagraphs("Hello World https://example.com", [
            {
              offset: 12,
              length: 19,
              type: "url",
  ...
  test("paragraph with link", () => {
    expect(
      diff(
        toNotionBlocks(
          toParagraphs("Hello World with link", [
            {
              offset: 12,
              length: 9,
              type: "text_link",
  ...
  test("paragraph with bold text", () => {
    expect(
      diff(
        toNotionBlocks(
          toParagraphs("Hello World bold text", [
            {
              offset: 12,
              length: 9,
              type: "bold",
  ...
  test("paragraph with underline text", () => {
    expect(
      diff(
        toNotionBlocks(
          toParagraphs("Hello World underline text", [
            {
              offset: 12,
              length: 14,
              type: "underline",
  ...
  test("paragraph with italic text", () => {
    expect(
      diff(
        toNotionBlocks(
          toParagraphs("Hello World italic text", [
            {
              offset: 12,
              length: 11,
              type: "italic",
  ...
  test("paragraph with strikethrough text", () => {
    expect(
      diff(
        toNotionBlocks(
          toParagraphs("Hello World strikethrough text", [
            {
              offset: 12,
              length: 18,
              type: "strikethrough",
  ...
  test("paragraph with inline code", () => {
    expect(
      diff(
        toNotionBlocks(
          toParagraphs('Hello World console.log("Hi")', [
            {
              offset: 12,
              length: 17,
              type: "code",
